...
export class DialogAssignementComponent implements OnInit {
     ...
     */
    constructor(private _dialogService: NbDialogService, private _peopleService: PersonService) {
    ...
    open(dialog: TemplateRef<any>) {
        this._peopleService.fecth().subscribe( (_: Person[]) => {
            ...
            this._dialogService.open(dialog, { closeOnBackdropClick: false , context: ''});
        });
    }
